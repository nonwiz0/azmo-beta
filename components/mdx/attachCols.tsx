export default function AttachCols({ section }) {
  return (
    <>
      <div className="flex-row md:flex gap-2 space-y-5 md:space-y-0">
        ...
        <div className="flex w-full h-24 mx-auto overflow-hidden bg-white rounded-lg shadow-lg transition duration-200 ease-in-out transform hover:-translate-y-1 group">
          <div
            className="w-2/3 bg-center bg-cover sm:w-28 md:w-32 lg:w-40 "
            style={{ backgroundImage: `url(${section.image1})` }}
          ></div>
          <div className="w-full p-2">
            <span className="text-gray-600">{section.content1}</span>
            <div className="flex justify-end">
              <a
                href={`${ section.link &&
                  section?.link.indexOf("http") > -1
