      ...
      <Container className={`relative z-10 py-0 max-w-8xl dark:bg-wgray-800`}>
        <div className="flex items-center justify-between">
          ...
          <div className="justify-between hidden space-x-2 md:flex">
            <Link href="/">
              <a
                className={`text-opacity-90 trasition duration-200 ease-in-out text-wgray-600 group bg-white hover:text-wgray-200 px-3 py-2 hover:bg-wgray-500 rounded-md items-center text-base font-medium hover:text-opacity-100`}
              >
                Home
              </a>
            </Link>
            <Popover className="relative">
              {({ open }) => (
                <>
                  <Popover.Button
                    className={`inline-flex text-opacity-90 trasition duration-200 ease-in-out text-wgray-600 group bg-white hover:text-wgray-200 px-3 py-2 hover:bg-wgray-500 rounded-md items-center text-base font-medium hover:text-opacity-100 ${
                      open && "bg-wgray-400 text-wgray-100"
                    }`}
                  >
                    <span>Posts</span>
                  ...
                  ml-2 h-5 w-5 text-wgray-300 group-hover:text-opacity-80 transition ease-in-out duration-150`}
                      aria-hidden="true"
                    />
                  </Popover.Button>
                  <Transition
                    ...
                    <Popover.Panel className="absolute z-20 w-screen max-w-sm px-4 mt-3 transform -translate-x-1/2 left-1/2 sm:px-0">
                      <div className="overflow-hidden rounded-lg shadow-lg ring-1 ring-black ring-opacity-5">
                        ...
                        <div className="p-4 bg-gray-50">
                          <Link href="/posts">
                            <a className="px-2 py-2 flow-root transition duration-150 ease-in-out rounded-md hover:bg-gray-100 focus:outline-none focus-visible:ring focus-visible:ring-orange-500 focus-visible:ring-opacity-50">
          ...
          <div>
            ...
            <Popover className="md:hidden">
              {({ open }) => (
                ...
                text-wgray-600 group hover:bg-wgray-600 hover:text-wgray-50 focus:bg-wgray-700 focus:text-wgray-50 px-3 py-2 rounded-md inline-flex items-center text-base font-medium hover:text-opacity-100 focus:outline-none focus-visible:ring-2 focus-visible:ring-white focus-visible:ring-opacity-75`}
                  >
                    <span>
                      ...
                      <div className="overflow-hidden rounded-lg shadow-lg ring-1 ring-black ring-opacity-5">
                        <div className="relative bg-white grid gap-8 p-7 lg:grid-cols-2">
                          <div className="flex flex-row justify-between">
                            ...
                            <div className="-mr-2">
                              <Popover.Button className="inline-flex items-center justify-center p-2 rounded-md text-wgray-400 dark:text-cgray-50 hover:text-wgray-500 dark:hover:text-white focus:outline-none focus:ring-2 focus:ring-inset focus:ring-wgray-200">
